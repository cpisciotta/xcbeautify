...
struct FormattedStringTests {
    ...
    @Test func nestedColorWithinBoldSegmentAndItalicTail() {
        ...
        let greenWord = "green".green()
        let redWord = "red".red()
        let boldClause = "is a \(greenWord) and \(redWord) bold string".bold()
        let italicClause = "this is italic.".italic()
    ...
    @Test func nestedBoldAndItalicWithinColoredSegment() {
        ...
        let boldWord = "bold".bold()
        let italicWord = "italic".italic()
        let coloredClause = "is a \(boldWord) and \(italicWord) colored".green()
